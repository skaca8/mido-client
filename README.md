...
dependencies {
    implementation 'com.github.skaca8:mido-client:1.1.1'
}
```
...
> To use a specific release, replace `1.1.1` with a tag or a commit hash.
...
```gradle
implementation 'io.github.skaca8:mido-client:1.1.1'
```
